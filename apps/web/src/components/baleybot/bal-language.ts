...
const BAL_COMPLETIONS = {
  keywords: [
    ...
    { label: 'try', detail: 'Error handling', insertText: 'try {\n  $0\n} catch {\n  \n}' },
    { label: 'route', detail: 'Multi-way routing', insertText: 'route($1) {\n  "$2": $0\n}' },
    { label: 'gate', detail: 'Conditional execution', insertText: 'gate("$1") {\n  $0\n}' },
    { label: 'filter', detail: 'Filter array items', insertText: 'filter("$1") {\n  $0\n}' },
    { label: 'processor', detail: 'Data transformation', insertText: 'processor("$1") {\n  "$0"\n}' },
  ...
  properties: [
    ...
    { label: 'temperature', detail: 'Model creativity (0-2)', insertText: '"temperature": $0' },
    { label: 'reasoning', detail: 'Extended thinking', insertText: '"reasoning": "$0"' },
    { label: 'stopWhen', detail: 'Stop condition', insertText: '"stopWhen": "$0"' },
    { label: 'retries', detail: 'Retry on failure', insertText: '"retries": $0' },
    { label: 'can_request', detail: 'Tools needing approval', insertText: '"can_request": { $0 }' },
  ],
  types: [
  ...
  models: [
    { label: 'anthropic:claude-opus-4-20250514', detail: 'Opus (ultra)' },
    { label: 'anthropic:claude-sonnet-4-20250514', detail: 'Sonnet (powerful, default)' },
    { label: 'anthropic:claude-haiku-4-5-20251001', detail: 'Haiku (fast)' },
    { label: 'openai:o3', detail: 'o3 (ultra)' },
    { label: 'openai:gpt-5', detail: 'GPT (powerful)' },
    { label: 'openai:gpt-5-mini', detail: 'GPT Mini (fast)' },
    { label: 'openai:gpt-4.1', detail: 'GPT 4.1 (balanced)' },
    { label: 'openai:gpt-4.1-mini', detail: 'GPT 4.1 Mini (fast)' },
    { label: 'openai:o4-mini', detail: 'o4 Mini (balanced)' },
    { label: 'ollama:llama3.2', detail: 'Llama 3.2 (local)' },
  ],
  tools: [
