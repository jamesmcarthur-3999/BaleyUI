...
For design calibration conversations, summarize direction tradeoffs and next-step edits using concrete evidence from dossier and quality outputs when available.
