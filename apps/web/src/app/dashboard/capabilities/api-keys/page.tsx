...
import { Plus, Copy, Trash2, Key, AlertTriangle, CheckCircle2, Calendar } from 'lucide-react';
...
export default function CapabilityApiKeysPage() {
  ...
  function setQuickExpiration(days: number | null) {
    if (days === null) {
      setExpirationDate('');
    } else {
      const date = new Date();
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <p className="text-sm text-muted-foreground">
          Allow external apps to access your workspace programmatically
        </p>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <Button type="button" variant="outline" size="sm" onClick={() => setQuickExpiration(30)}>
                    30 days
                  </Button>
                  <Button type="button" variant="outline" size="sm" onClick={() => setQuickExpiration(90)}>
                    90 days
                  </Button>
                  <Button type="button" variant="outline" size="sm" onClick={() => setQuickExpiration(365)}>
                    1 year
                  </Button>
                </div>
